...
$db=Config::getConnexion();
    ...
    $nb3 = $req3->fetch();
$dataPoints = array(array("label"=> date("Y"), "y"=> intval($nb1['nb1'])));
  $dataPoints = array(array("label"=> date("Y"), "y"=> intval($nb2['nb2'])));
$dataPoints = array(array("label"=> date("Y"), "y"=> intval($nb3['nb3'])));
