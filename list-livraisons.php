                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Blog Details" href="livraison-add.html"><i class="fa fa-pencil sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Editer un livraison</span></a></li>
                            </ul>
                        </li>
                        <li>
        ...
        <div class="single-product-tab-area mg-tb-15">
            ...
            <div class="single-pro-review-area">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input value="<?php echo $id ?>" name="a" type="text" class="form-control" placeholder="id">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $mail ?>" name="mail" type="text" class="form-control" placeholder="mail">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input value="<?php echo $idlivreur ?>" name="idlivreur" type="text" class="form-control" placeholder="Téléphone">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input value="<?php echo $commande ?>" name="b" type="text" class="form-control" placeholder="commande">
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
                                                        <input value="<?php echo $etatdelivraison ?>" name="c" type="text" class="form-control" placeholder="Véhicule">
                                                    </div>
                ...
                if (isset($_POST['modifier'])){
                  $livraison=new livraison($_POST['a'],$_POST['mail'],$_POST['adresse'],$_POST['idlivreur'],$_POST['b'],$_POST['c']);
