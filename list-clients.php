                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Google Map" href="list-clients.php"><i class="fa fa-list sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Liste des clients</span></a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <div class="product-status-wrap">
                            ...
                            <button onclick="printData()">Imprimer</button>
                                ...
                                <tr>
                                    ...
                                    <th onclick="sortTable(4)">Mail</th>
                                    <th onclick="sortTable(5)">Adresse</th>
                                    <th onclick="sortTable(6)">Numéro</th>
                                    <th onclick="sortTable(7)">Point de fidélité</th>
                                    <th onclick="sortTable(8)">Mot de passe</th>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['point_f']; ?> </td>
                                    <td><?php echo $row['mot_dp']; ?> </td>
                                    
                                     
                                      <td>  
                                        
                                        <form method="POST" action="supprimer-client.php"> 
